    ...
    */
    "list" => [
            [
                    "name"        => "Dashboard",
                    "route"       => "dashboard",
                    "link"        => '/works/public/admin/users/dashboard',
                    "permissions" => []
            ],
            [
                /*
                 ...
                 */
                "link"        => '/works/public/admin/users/list',
                /*
            ...
            [
                    "name"        => "Groups",
                    "route"       => "groups",
                    "link"        => '/works/public/admin/groups/list',
                    "permissions" => ["_superadmin", "_group-editor"]
            ],
            [
                    "name"        => "Permission",
                    "route"       => "permission",
                    "link"        => '/works/public/admin/permissions/list',
            ...
            [
                ...
                "name"        => "sample",
                "route"       => "selfprofile",
                "link"        => '/works/public/admin/sample',
                "permissions" => []
            ],
